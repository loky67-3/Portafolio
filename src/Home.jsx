...
const ServicesPage = ({ handleNavigate }) => {
  ...
  const serviceCards = [
    // Opciones de $3,000
    { id: 101, price: '$3,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=1974&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg>, title: 'Tarjeta Digital Interactiva', description: 'Tu presentación profesional en un formato digital moderno y compartible.' },
    { id: 102, price: '$3,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>, title: 'Landing Page Express', description: 'Una página de aterrizaje rápida y efectiva para campañas específicas.' },
    { id: 103, price: '$3,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1562577309-4932fdd64cd1?q=80&w=1974&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>, title: 'Mantenimiento Básico', description: 'Actualizaciones de seguridad y contenido menores mensuales.' },
    { id: 104, price: '$3,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1560472355-536de3962603?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>, title: 'Auditoría SEO Inicial', description: 'Diagnóstico de tu sitio web para mejorar su visibilidad en buscadores.' },
    { id: 105, price: '$3,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?q=80&w=1974&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>, title: 'Setup de Redes Sociales', description: 'Configuración profesional de perfiles en Facebook, Instagram o LinkedIn.' },
    
    // Opciones de $4,000
    { id: 1, price: 'A partir de $4,000 MXN', href: 'https://plantas-8uw8.onrender.com', image: 'https://images.unsplash.com/photo-1559028006-448665bd7c2f?q=80&w=1974&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5.34"></path><polygon points="18 2 22 6 12 16 8 16 8 12 18 2"></polygon></svg>, title: 'Landing Pages de Alto Impacto', description: 'Páginas de aterrizaje optimizadas para la máxima conversión de clientes.' },
    
    // Opciones de $5,000
    { id: 106, price: '$5,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=2072&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line></svg>, title: 'Web Informativa Pyme', description: 'Sitio web de hasta 4 secciones ideal para pequeños negocios.' },
    { id: 107, price: '$5,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1499750310159-5b9887039e54?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>, title: 'Blog Personal / Profesional', description: 'Plataforma autogestionable para publicar tus artículos y noticias.' },
    { id: 108, price: '$5,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1545235617-9465d2a55698?q=80&w=2080&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>, title: 'Portafolio Digital', description: 'Galería interactiva para fotógrafos, diseñadores y arquitectos.' },
    { id: 109, price: '$5,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polygon points="10 8 16 12 10 16 10 8"></polygon></svg>, title: 'Optimización WPO', description: 'Mejora de velocidad de carga para sitios web existentes.' },
    { id: 110, price: '$5,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1531403009284-440f080d1e12?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>, title: 'Integración Chatbot', description: 'Chat automatizado básico para atención al cliente 24/7.' },

    // Opciones de mayor precio
    { id: 2, price: 'A partir de $12,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=2015&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>, title: 'Sitios Web Corporativos', description: 'Proyecta una imagen profesional y sólida con un sitio web a la medida.' },
    { id: 3, price: 'A partir de $25,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1516116216624-53e697314945?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>, title: 'Aplicaciones Web (SPA)', description: 'Desarrollo de aplicaciones complejas, rápidas y escalables con React o Next.js.' },
    { id: 4, price: 'A partir de $30,000 MXN', href: '#', image: 'https://images.unsplash.com/photo-1522199755839-a2bacb67c546?q=80&w=2072&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>, title: 'Tiendas en Línea (E-commerce)', description: 'Soluciones completas de comercio electrónico con pasarelas de pago seguras.' },
    
    // Opciones a Cotizar
    { id: 5, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>, title: 'Sistemas de Contenido (CMS)', description: 'Plataformas autogestionables robustas para grandes volúmenes de información.' },
    { id: 6, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1607252650355-f7fd0460ccdb?q=80&w=1974&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect><line x1="12" y1="18" x2="12.01" y2="18"></line></svg>, title: 'Apps para iOS y Android', description: 'Aplicaciones nativas o híbridas para llegar a tus usuarios en cualquier dispositivo.' },
    { id: 7, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"></path></svg>, title: 'Diseño de Interfaz de Usuario (UI)', description: 'Creación de interfaces visualmente atractivas, intuitivas y coherentes con tu marca.' },
    { id: 8, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21.5 12c0-5.25-4.25-9.5-9.5-9.5S2.5 6.75 2.5 12s4.25 9.5 9.5 9.5c.83 0 1.64-.11 2.4-.31"></path><path d="M16 8.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5.67-1.5 1.5-1.5.5.25.5.5"></path><path d="M8 8.5c0 .83-.67 1.5-1.5 1.5S5 9.33 5 8.5 5.67 7 6.5 7s1.5.67 1.5 1.5z"></path><path d="M15.5 14.5c-1.5 0-2.5 1-2.5 2"></path></svg>, title: 'Análisis de Experiencia de Usuario (UX)', description: 'Investigación y prototipado para asegurar que tu producto sea fácil y agradable de usar.' },
    { id: 9, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"></rect><rect x="2" y="14" width="20" height="8" rx="2" ry="2"></rect><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg>, title: 'Desarrollo de APIs REST/GraphQL', description: 'Creación de backends robustos para comunicar tus apps con servidores y bases de datos.' },
    { id: 10, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path></svg>, title: 'Arquitectura de Microservicios', description: 'Diseño de sistemas escalables y desacoplados para aplicaciones de gran envergadura.' },
    { id: 11, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1554224155-1696413565d3?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>, title: 'Auditoría de Seguridad', description: 'Análisis de vulnerabilidades y fortalecimiento de la seguridad de tus aplicaciones web.' },
    { id: 12, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>, title: 'Optimización de Rendimiento Web', description: 'Mejora de la velocidad de carga y la eficiencia para una mejor experiencia y SEO.' },
    { id: 13, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>, title: 'Consultoría Tecnológica', description: 'Asesoramiento experto para elegir la mejor arquitectura y tecnologías para tu proyecto.' },
    { id: 14, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1587560699334-cc4ff634909a?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path></svg>, title: 'Mantenimiento y Soporte', description: 'Planes de soporte para garantizar que tu aplicación esté siempre actualizada y funcionando.' },
    { id: 15, price: 'Cotizar', href: '#', image: 'https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=2070&auto=format&fit=crop', icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>, title: 'Integración de Servicios de Terceros', description: 'Conexión de tu plataforma con APIs externas como redes sociales, mapas, etc.' },
  ];
    ...
    <div className="services-page-layout">
      ...
      <main className="services-content-main">
        <header className="services-content-header">
          <button className="services-back-button" onClick={() => handleNavigate('home')}>
        ...
        <div className="services-grid-container">
          {serviceCards.map(card => (
            <div className="service-detail-card" key={card.id}>
              <a href={card.href} className="service-detail-image-link" target={card.href.startsWith('http') ? '_blank' : '_self'} rel="noopener noreferrer">
                <div className="service-detail-image-wrapper">
                  <img src={card.image} alt={card.title} className="service-detail-image" />
                </div>
              </a>
              <div className="service-detail-content">
                ...
                <div className="service-detail-bottom">
                  <div className="service-detail-price">{card.price}</div>
                  <a href={card.href} className="service-detail-button" target={card.href.startsWith('http') ? '_blank' : '_self'} rel="noopener noreferrer">Ver Detalles</a>
                </div>
              </div>
            </div>
          ))}
